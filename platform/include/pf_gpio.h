...
extern void GPIOPinIntEnable(unsigned int moduleId,unsigned int pinNumber,unsigned int intTrigFlag);
extern void GPIOPinIntDisable(unsigned int moduleId,unsigned int pinNumber,unsigned int intTrigFlag);
