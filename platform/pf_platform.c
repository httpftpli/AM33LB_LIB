...
MUX_VAL(CONTROL_PADCONF_GPMC_AD0, (IEN | PU | MODE0 )) /* GPMC_AD0 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD1, (IEN | PU | MODE0 )) /* GPMC_AD1 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD2, (IEN | PU | MODE0 )) /* GPMC_AD2 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD3, (IEN | PU | MODE0 )) /* GPMC_AD3 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD4, (IEN | PU | MODE0 )) /* GPMC_AD4 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD5, (IEN | PU | MODE0 )) /* GPMC_AD5 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD6, (IEN | PU | MODE0 )) /* GPMC_AD6 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD7, (IEN | PU | MODE0 )) /* GPMC_AD7 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD8, (IEN | PU | MODE0 )) /* GPMC_AD8 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD9, (IEN | PU | MODE0 )) /* GPMC_AD9 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD10, (IEN | PU | MODE0 )) /* GPMC_AD10 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD11, (IEN | PU | MODE0 )) /* GPMC_AD11 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD12, (IEN | PU | MODE0 )) /* GPMC_AD12 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD13, (IEN | PU | MODE0 )) /* GPMC_AD13 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD14, (IEN | PU | MODE0 )) /* GPMC_AD14 */\
MUX_VAL(CONTROL_PADCONF_GPMC_AD15, (IEN | PU | MODE0 )) /* GPMC_AD15 */\
...
MUX_VAL(CONTROL_PADCONF_GPMC_CLK, (IEN | PD | MODE2 )) /* GPMC_WAIT1 */\
