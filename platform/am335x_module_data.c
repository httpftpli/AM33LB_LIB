...
MODULE modulelist[128] = {
   ...
   [MODULE_ID_UART1] =  {.index=1,.baseAddr = SOC_UART_1_REGS,.INTNum={SYS_INT_UART1INT,0,0},.INTPriority={INT_PRIORITY_UART1,0,0},.isr={IS_TSC,0,0},.moduleClk=&uart1ModClock},
