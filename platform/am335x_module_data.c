...
extern void isr_uart(unsigned int intnum);
...
MODULE modulelist[128] = {
   ...
   [MODULE_ID_eCAP1] = {.index=0, .baseAddr = SOC_ECAP_1_REGS,.INTNum={SYS_INT_eCAP1INT,0,0},  .INTPriority={INT_PRIORITY_eCAP1,0,0},.isr={isr_ecap,0,0},.moduleClk=&epwmss1ModClock},
   ...
   [MODULE_ID_UART2] =  {.index=1,.baseAddr = SOC_UART_2_REGS,.INTNum={SYS_INT_UART2INT,0,0},.INTPriority={INT_PRIORITY_UART2,0,0},.isr={isr_uart,0,0},.moduleClk=&uart2ModClock},
   ...
   [MODULE_ID_UART4] =  {.index=1,.baseAddr = SOC_UART_4_REGS,.INTNum={SYS_INT_UART4INT,0,0},.INTPriority={INT_PRIORITY_UART4,0,0},.isr={0,0,0},.moduleClk=&uart4ModClock},
