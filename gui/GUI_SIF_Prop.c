...
static int _GetNumCharAreas(const GUI_FONT   * pFont) {
  ...
  NumCharAreas = GUI__Read16((void const **)&pData);
  return NumCharAreas;
}
...
static const U8 * _GetpCharInfo(const GUI_FONT   * pFont, U16P c) {
  ...
  do {
    ...
    CharArea.First    = GUI__Read16((void const **)&pCharArea);
    CharArea.Last     = GUI__Read16((void const **)&pCharArea);
...
static int _GUI_SIF_GetCharDistX(U16P c) {
  ...
  if (pCharInfo) {
    ...
    DistX = GUI__Read16((void const **)&pCharInfo);
  }
  return DistX;
}
...
static void _GUI_SIF_GetFontInfo(const GUI_FONT   * pFont, GUI_FONTINFO * pfi) {
  ...
  pfi->Baseline = GUI__Read16((void const **)&pData);
  pfi->LHeight  = GUI__Read16((void const **)&pData);
  pfi->CHeight  = GUI__Read16((void const **)&pData);
...
BOOL GUI_SIF_CreateFont(const void * pFontData, GUI_FONT * pFont, const GUI_SIF_TYPE * pFontType) {
  ...
  pFont->YDist    = GUI__Read16((void const **)&pSrc);
  pFont->Baseline = GUI__Read16((void const **)&pSrc);
  pFont->LHeight  = GUI__Read16((void const **)&pSrc);
  pFont->CHeight  = GUI__Read16((void const **)&pSrc);
