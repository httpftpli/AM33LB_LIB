...
extern unsigned int  Dis_DrawChar(unsigned short character,unsigned int x,unsigned int y,COLOR color_f,COLOR color_b);
extern void Dis_DrawText(unsigned short *text,unsigned int x,unsigned int y,COLOR color_f,COLOR color_b);
